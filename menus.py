...
def menu(con, header, options, width, screen_width, screen_height):
    ...
    header_height = libtcod.console_get_height_rect(con, 9, 9, width, screen_height, header)
    height = len(options) + header_height

    #create an off-screen console that represents the menu's window
    window = libtcod.console_new(width, height)

    #print the header, with the auto-wrap
...
def main_menu(con, background_image, screen_width, screen_height):
    ...
    libtcod.console_print_ex(0, int(screen_width / 2), int(screen_height - 2), libtcod.BKGND_NONE, libtcod.CENTER, 'By Vadersnotmydad')
...
def character_screen(player, character_screen_width, character_screen_height, screen_width, screen_height):
    ...
    libtcod.console_blit(window, 0, 0, character_screen_width, character_screen_height, 0, x, y, 1.0, 7.0)
