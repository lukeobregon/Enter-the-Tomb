...
class GameMap:
    ...
    def place_entities(self, room, entities):
        max_monster_per_room = from_dungeon_level([[2, 1], [3, 4], [5, 6]], self.dungeon_level)
        max_items_per_room = from_dungeon_level([[1, 1], [2, 4]], self.dungeon_level)

        number_of_monster = randint(0, max_monster_per_room)
        ...
        item_chances = {
            ...
            'shield': from_dungeon_level([[100, 8]], self.dungeon_level) 
            }

        for i in range(number_of_monster):
            #choose a ranom location in the room
        ...
        for i in range(number_of_items):
            #choosing random location for items in a room
            x = randint(room.x1 + 1, room.x2 - 1)
            y = randint(room.y1 + 1, room.y2 - 1)
    ...
    def next_floor(self, player, message_log, constants):
        self.dungeon_level += 1 #first create the player
        entities = [player]

        self.tiles = self.initialize_tiles() #then carve out the rooms
